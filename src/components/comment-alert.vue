<template>
    <div class="comment-alert">
        ...
        <div class="btn-container" v-if="!data.isagree">
            <div v-bind:class="{'no':true,'border-b-l-radius':true}" @click="closeAlert">No</div>
            <router-link  v-bind:class="{'yes':true,'border-b-l-radius':data.isagree}" :to="{ name: 'outsideReview', params: { id: 'myid' }}"><div>Yes</div></router-link>
        </div>
        <div class="btn-container" v-if="data.isagree">
