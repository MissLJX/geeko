        ...
        <div v-if="order" class="st-order-body">
            ...
            <div class="st-order-bgline">
                <div class="orderheader st-table">
                    ...
                    <div class="st-row" v-if="changePackage.slug != null && (order.status === 3 || order.status === 5)">
                        <div class="st-cell st-v-m special-color">Logistics Company</div>
                        <div class="st-cell st-v-m t-right">{{changePackage.slug}}</div>
                    </div>

                    <div class="st-row"  v-if="changePackage.trackingNumber != null && (order.status === 3 || order.status === 5)">
            ...
            <div class="payment-method" v-if="order.payMethodName != null">
                <div class="__title">
                    Payment Method
                </div>
                <div class="__content">
                    <img src="https://s3-us-west-2.amazonaws.com/image.chic-fusion.com/chicme/20210518/paypal.png" alt="PayPal">
                    <span>PayPal</span>
                </div>
            </div>
            ...
            <div class="fd_fixed">
                ...
                <!-- unpaid status:0  Shipped status:3   Confirm status:5 -->
                <div class="l-container" v-if="order.status === 0 || order.status === 3 || order.status === 5">
                    ...
                    <a class="btn" v-if="order.status === 3" @click="confirmHandle">Order Confirm</a>

                    <a class="cancel-btn" v-if="order.status === 3">Logistics Status</a>

                    <!-- <router-link :to="{name : 'returnLogistics'}" class="btn" style="margin-right:20px;">Return Logistics</router-link> -->
                </div>
            </div>
